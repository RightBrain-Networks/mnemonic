"""Read-only code-review integrity audit for supported schemas 0024 through 0027.
...
SUPPORTED_HEADS = (REVIEW_HEAD, "0025_cross_project_relationships", "0026_artifact_library", HEAD)
CHECKS = {
