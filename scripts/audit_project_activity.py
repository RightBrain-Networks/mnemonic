...
PROMPT_LIBRARY_HEADS = (
    ...
    "0038_transcript_recovery", "0039_manual_review_requests", "0040_normalized_transcripts", "0041_artifact_passages", "0042_transcript_health", "0046_shared_transcript_copies", "0047_artifact_transfer", "0048_force_claims", HEAD,
)
...
def _review_checks(expected_head: str) -> dict[str, str]:
    ...
    spec.loader.exec_module(module)
    return {
        f"code_review_{name}": sql for name, sql in module.checks_for_head(expected_head).items()
    }
...
def _head_findings(
    ...
    if expected_head in {"0038_transcript_recovery", "0039_manual_review_requests", "0040_normalized_transcripts", "0041_artifact_passages", "0042_transcript_health", "0046_shared_transcript_copies", "0047_artifact_transfer", "0048_force_claims", HEAD}:
