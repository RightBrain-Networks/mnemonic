...
def validate_rest_contract(document: Any) -> None:
    ...
    try:
        require(document["info"]["version"] == "0.71.0", "Unexpected REST API version.")
        schemas = document["components"]["schemas"]
...
def validate_mcp_catalog(catalog: Any) -> None:
    ...
    require(
        len(catalog.tools) == 56
        and len(tools_by_name) == 56
    ...
    require(
        {"project_id", "q", "facets", "fulltext", "detail", "filters", "sort", "facet_order",
         "limit", "offset"}.issubset(search_properties)
        and search_properties["fulltext"].get("default") is False
        and search_properties["limit"].get("default") == 20
        and search_properties["detail"].get("default") == "compact"
        ...
        async with streamablehttp_client(args.mcp_url, headers=auth, timeout=65) as (  # noqa: SIM117
            ...
            async with ClientSession(read, write) as session:
                ...
                require(
                    ...
                    and initialized.serverInfo.version == "0.71.0",
                ...
                print(
                    "PASS: REST 0.71.0 cross-project relationship contract shape, work-move, "
                    "code-review contract, real MCP initialization, 56-tool catalog, "
