...
def validate_rest_contract(document: Any) -> None:
    ...
    try:
        require(document["info"]["version"] == "0.61.0", "Unexpected REST API version.")
        schemas = document["components"]["schemas"]
        ...
        async with streamablehttp_client(args.mcp_url, headers=auth, timeout=65) as (  # noqa: SIM117
            ...
            async with ClientSession(read, write) as session:
                ...
                require(
                    ...
                    and initialized.serverInfo.version == "0.61.0",
                ...
                print(
                    "PASS: REST 0.61.0 cross-project relationship contract shape, work-move, "
