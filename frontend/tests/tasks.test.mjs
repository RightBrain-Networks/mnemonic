...
const task = { id: review, kind: "code_review", project_id: project, work_item_id: work,
  title: "Review cache changes", summary: "Check concurrent readers.", status: "pending",
...
test("task pages reject cross-project rows, wrong task kinds and incoherent leases", () => {
  ...
  for (const change of [{ project_id: work }, { kind: "work_item" }, { status: "active" }, { id: "invalid" }]) {
