...
test("the route allowlist exposes canonical Phase 3 work, hierarchy, and relationship operations and compatibility aliases", () => {
  ...
  assert.deepEqual(allowedQueryKeys(`projects/${project}/work-items`, "GET"), ["q", "semantic", "status", "sort", "tag", "source_client", "external_url", "source_session_id", "view", "detail", "duplicate_scope", "canonical_work_item_id", "limit", "offset"]);
