...
test("Advisory states stay optional, accessible, stale-safe, and bidi-isolated", async ({
  ...
  const suggestionResponse = {
    ...
    limit: 5,
    mode: "lexical",
    semantic: { inference: { status: "unavailable", reason: "model_failure" }, candidate_scope: "none", partial_vectors: false, comparison_incomplete: true, retry: null, cache_refresh: { status: "not_needed", reason: null } }, semantic_available: false,
