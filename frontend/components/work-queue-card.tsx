...
export default function WorkQueueCard({ summary, presentation, depth = 0 }: Props) {
  ...
  const reviewLocked = Boolean(summary.readiness.review_status || summary.readiness.display_state === "to-review");
  const actionsDisabled = mutationBlocked || summary.readiness.is_duplicate;
