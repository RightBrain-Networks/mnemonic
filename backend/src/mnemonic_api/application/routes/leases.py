...
The dashboard-only Pending route never accepts or returns a token. It clears
the exact safe lease state the person reviewed with dashboard-human provenance.
"""
