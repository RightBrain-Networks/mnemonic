...
The current application/API/MCP/dashboard release is `0.17.0`, Claude plugin
`0.16.0`, and Alembic head `0025_cross_project_relationships`. The catalog is exactly
