...
Application/API/MCP/dashboard `0.41.0`, plugin `0.24.0`, and current migration
`0031_review_decisions` support files outside Git and local full-text search. Each artifact belongs permanently
...
Upgrade API, MCP and dashboard together to `0.41.0`, plugin `0.24.0`, and migration
`0031_review_decisions`. Migration 0029 initially marked older artifacts
