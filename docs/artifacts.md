...
Application/API/MCP/dashboard `0.52.1`, plugin `0.30.1`, and current migration
`0038_transcript_recovery` support files outside Git and local full-text search. Each artifact belongs permanently
...
Upgrade API, MCP and dashboard together to `0.52.1`, plugin `0.30.1`, and migration
`0038_transcript_recovery`. Migration 0029 initially marked older artifacts
