...
release is application/API/MCP/dashboard `0.60.0`, plugin `0.38.0`, and migration
`0041_artifact_passages`. [Human review actions](code-reviews.md#human-review-decisions-0410)
