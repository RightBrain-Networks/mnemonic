...
release is application/API/MCP/dashboard `0.52.0`, plugin `0.30.0`, and migration
`0037_background_jobs`. [Human review actions](code-reviews.md#human-review-decisions-0410)
