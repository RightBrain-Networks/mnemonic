...
release is application/API/MCP/dashboard `0.28.0`, plugin `0.20.0`, and migration
...
with opt-in content matching in MCP and the dashboard. Reviews add project thresholds, durable
