...
Existing transcript imports ship in 0.45.1; see [transcripts](transcripts.md).
...
release is application/API/MCP/dashboard `0.58.0`, plugin `0.36.0`, and migration
`0040_normalized_transcripts`. [Human review actions](code-reviews.md#human-review-decisions-0410)
...
Tika extraction, PostgreSQL text/properties and Tantivy full-text search are shipped,
