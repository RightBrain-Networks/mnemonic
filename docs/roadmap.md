...
release is application/API/MCP/dashboard `0.49.0`, plugin `0.29.0`, and migration
`0035_prompt_library`. [Human review actions](code-reviews.md#human-review-decisions-0410)
