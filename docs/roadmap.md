...
release is application/API/MCP/dashboard `0.57.0`, plugin `0.35.0`, and migration
`0039_manual_review_requests`. [Human review actions](code-reviews.md#human-review-decisions-0410)
