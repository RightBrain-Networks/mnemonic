...
release is application/API/MCP/dashboard `0.35.0`, plugin `0.23.0`, and migration
`0029_artifact_links_sensitive`. [Artifacts](artifacts.md) add project-scoped file uploads,
