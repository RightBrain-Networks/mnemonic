...
release is application/API/MCP/dashboard `0.48.0`, plugin `0.28.0`, and migration
`0034_variable_work_leases`. [Human review actions](code-reviews.md#human-review-decisions-0410)
