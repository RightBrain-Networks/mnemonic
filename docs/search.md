...
configuration was required for that release. Current release 0.50.0 uses migration
`0035_prompt_library` and also searches [imported transcripts](transcripts.md#import-existing-transcripts).
