...
configuration was required for that release. Current release 0.52.0 uses migration
`0037_background_jobs` and also searches [imported transcripts](transcripts.md#import-existing-transcripts).
