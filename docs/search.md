...
configuration was required for that release. Current release 0.48.0 uses migration
`0034_variable_work_leases` and also searches [imported transcripts](transcripts.md#import-existing-transcripts).
