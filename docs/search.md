...
configuration was required for that release. Current release 0.53.0 uses migration
`0038_transcript_recovery` and also searches [imported transcripts](transcripts.md#import-existing-transcripts).
