...
INSTRUCTIONS = (
    ...
    "recall_work for one item's bounded context, claim_and_recall instead once the user has "
    "authorized execution, add_checkpoint to extend it, and complete_work or release_claim to "
    "end a claim. "
