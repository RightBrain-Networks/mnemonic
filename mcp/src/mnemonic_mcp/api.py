...
_APPLICATION_ERRORS = {
    ...
    "prompt_unavailable": "Project prompt files are unavailable; ask the operator to restore access before continuing.",
    "prompt_not_found": "This prompt is not in the project's prompt library.",
    "prompt_render_too_large": "The expanded project prompt exceeds its bounds; ask the operator to shorten the template.",
    "invalid_prompt": "The project prompt is invalid; ask the operator to review it in Settings > Prompts.",
...
def _raise_remaining_response_error(
    ...
    *,
    ...
    if response.status_code == 422:
        ...
        raise InputValidationError(validation_error_message(*details), details=details)
